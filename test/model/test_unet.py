...
def test_unet_basic():
    ...
    unet = model_manager.create_model("unet", in_channels=3, out_channels=1, features=[64, 128, 256])
...
def test_unet_different_channels():
    ...
    unet = model_manager.create_model("unet", in_channels=1, out_channels=3, features=[32, 64, 128, 256])
...
def test_unet_with_activation_normalization():
    ...
    unet = model_manager.create_model(
        "unet", in_channels=3, out_channels=2, features=[32, 64], activation="leaky_relu", normalization="groupnorm"
    )
...
def test_unet_hyperparameters():
    ...
    hyperparams = model_manager.get_model_parameters("unet")
